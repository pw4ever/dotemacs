;;; poly-ansible-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "poly-ansible" '("jinja2-ansible-functions-keywords" "pm-inner/jinja2" "poly-ansible-mode"))
